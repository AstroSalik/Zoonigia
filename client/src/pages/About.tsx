...
const About = () => {
  return (
    <div className="min-h-screen bg-space-900 text-space-50">
      ...
      <section className="py-20 bg-space-800/30">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-space font-bold text-center mb-12">Community Voice</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            ...
            <GlassMorphism className="p-8">
              ...
              <p className="text-space-200 leading-relaxed italic">
                "From joining as just a community member with curiosity and passion… to growing into the Administrative Assistant and one of the core members of this ever-evolving company — every step has been a story in itself.

Over time, I've had the privilege of wearing many hats — from mentoring students and organizing community projects to handling HR responsibilities, managing our socials, and keeping the rhythm of the company alive even when things got a little too quiet.

The path wasn't always smooth — some days tested my patience, others tested my belief — but every challenge turned out to be a lesson in disguise. I learned to adapt, to create, and most importantly, to keep moving with grace.
