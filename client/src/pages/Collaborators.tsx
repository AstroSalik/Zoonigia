    ...
    <div className="min-h-screen bg-space-900 text-space-50">
      ...
      <div className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <GlassMorphism className="p-6 text-center">
                <Globe className="w-12 h-12 text-cosmic-blue mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Global Reach</h3>
                <div className="text-3xl font-bold text-cosmic-blue mb-2">25+</div>
                <p className="text-space-400">Countries reached through partnerships</p>
              </GlassMorphism>

              <GlassMorphism className="p-6 text-center">
                <Target className="w-12 h-12 text-cosmic-green mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Research Impact</h3>
                <div className="text-3xl font-bold text-cosmic-green mb-2">50+</div>
                <p className="text-space-400">Joint research publications</p>
              </GlassMorphism>

              <GlassMorphism className="p-6 text-center">
                <Award className="w-12 h-12 text-cosmic-purple mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Student Success</h3>
                <div className="text-3xl font-bold text-cosmic-purple mb-2">500+</div>
                <p className="text-space-400">Student discoveries and achievements</p>
              </GlassMorphism>
            </div>
          </div>
          ...
          {/* Why Partner With Us */}
          <div className="mb-16">
            <h2 className="text-3xl font-space font-bold text-center mb-8">Why Partner With Zoonigia?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <GlassMorphism className="p-6 text-center">
                <Eye className="w-10 h-10 text-cosmic-blue mx-auto mb-4" />
                <h3 className="text-lg font-semibold mb-2">Visibility</h3>
                <p className="text-space-400 text-sm">Reach thousands of students and educators globally</p>
              </GlassMorphism>

              <GlassMorphism className="p-6 text-center">
                <Target className="w-10 h-10 text-cosmic-green mx-auto mb-4" />
                <h3 className="text-lg font-semibold mb-2">Impact</h3>
                <p className="text-space-400 text-sm">Make a real difference in science education</p>
              </GlassMorphism>

              <GlassMorphism className="p-6 text-center">
                <Network className="w-10 h-10 text-cosmic-purple mx-auto mb-4" />
                <h3 className="text-lg font-semibold mb-2">Network</h3>
                <p className="text-space-400 text-sm">Connect with global education leaders</p>
              </GlassMorphism>

              <GlassMorphism className="p-6 text-center">
                <DollarSign className="w-10 h-10 text-cosmic-orange mx-auto mb-4" />
                <h3 className="text-lg font-semibold mb-2">Growth</h3>
                <p className="text-space-400 text-sm">Be part of the EdTech revolution</p>
              </GlassMorphism>
            </div>
          </div>
          ...
          <div className="text-center">
            <GlassMorphism className="p-8 max-w-3xl mx-auto">
              ...
              <p className="text-space-300 mb-6">
                Join our mission to democratize quality science education and create the next generation of innovators.
              </p>
