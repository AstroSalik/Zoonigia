...
const teamRegistrationFormSchema = insertCampaignTeamRegistrationSchema.extend({
  ...
  teamMember4Email: z.string().optional().refine((val) => !val || z.string().email().safeParse(val).success, "Valid email is required"),
  teamMember4Phone: z.string().optional(),
  teamMember5Name: z.string().optional(),
  teamMember5Email: z.string().optional().refine((val) => !val || z.string().email().safeParse(val).success, "Valid email is required"),
