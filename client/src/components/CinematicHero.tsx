...
export default function CinematicHero() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-space-900 via-space-800/90 to-space-900">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className={`max-w-5xl mx-auto transition-all duration-2000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="space-y-6 sm:space-y-8 mb-8 sm:mb-12">
              ...
              <h1 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight px-4 sm:px-0 animate-fade-in">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-slate-300 max-w-4xl mx-auto leading-relaxed px-4 sm:px-0 animate-fade-in-delayed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center px-4 sm:px-0 animate-fade-in-delayed">
              <Link href="/courses">
                <Button 
                  size="lg" 
